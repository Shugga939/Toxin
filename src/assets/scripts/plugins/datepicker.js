...
;(function (window, $, undefined) { ;(function () {
    var VERSION = '2.2.3',
        ...
        defaults = {
            ...
            showEvent: 'none', //изменено в исходнике, т.к. в при в опциях параметр почему-то
            autoClose: false,

            // navigation
            monthsField: 'monthsShort',
            prevHtml: '<span class="arrow-prev"></span>', 
            nextHtml: '<span class="arrow-next"></span>', 
            navTitles: {
                days: 'MM <i>yyyy</i>',
                months: 'yyyy',
                years: 'yyyy1 - yyyy2'
    ...
    airDatepicker.prototype = {
        ...
        today: function () {
           ...
           /* this.silent = true;
            ...
            this.silent = false;
            this.date = new Date();*/ // реализация кнопки "Подтвердить"
        ...
        _onBlur: function () {
            // if (!this.inFocus && this.visible) {   убираем закрытие при выборе даты и потере фокуса
            //     this.hide();
            // }
        },
